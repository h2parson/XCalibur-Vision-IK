...
velocity1 = velocity(q1,max_v,min_v,start,range_,mid_start,mid_end) # calculate the velocities
...
velocity2 = velocity(q2,max_v,min_v,start,range_,mid_start,mid_end)

# np.savez("knife_data.npz", q1)
np.savez("knife_data.npz", q2, [], normals, common.flipZ(normals), profile, mid_start, mid_end, velocity2)
